...
var template = ({ head, body }) => '<!DOCTYPE html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<!-- <link rel="icon" href="/favicon.png" /> -->\n		<link\n			rel="stylesheet"\n			href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"\n			referrerpolicy="no-referrer"\n		/>\n		<link\n			href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,200;0,300;0,500;1,300&display=swap"\n			rel="stylesheet"\n		/>\n\n		<link\n			rel="stylesheet"\n			href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"\n			referrerpolicy="no-referrer"\n		/>\n\n		<meta name="viewport" content="width=device-width, initial-scale=1" />\n\n		' + head + '\n	</head>\n	<body>\n		<div id="svelte">' + body + "</div>\n	</body>\n</html>\n";
var options = null;
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-5dfffd9c.js",
      css: ["/./_app/assets/start-9e005e95.css"],
      js: ["/./_app/start-5dfffd9c.js", "/./_app/chunks/vendor-18270294.js"]
    },
    fetched: void 0,
    floc: false,
...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "robots.txt", "size": 67, "type": "text/plain" }, { "file": "video/.DS_Store", "size": 6148, "type": null }, { "file": "video/interstellar.mp4", "size": 11464242, "type": "video/mp4" }, { "file": "video/pin.mp4", "size": 29827718, "type": "video/mp4" }],
  ...
  routes: [
    ...
    },
    {
      ...
      pattern: /^\/church\/add\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/church/add.svelte"],
      b: ["src/routes/__error.svelte"]
    },
    {
      type: "page",
      pattern: /^\/video\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/video/index.svelte"],
      b: ["src/routes/__error.svelte"]
    },
    {
      type: "page",
      pattern: /^\/video\/([^/]+?)\/?$/,
      params: (m2) => ({ id: d(m2[1]) }),
      a: ["src/routes/__layout.svelte", "src/routes/video/[id].svelte"],
      b: ["src/routes/__error.svelte"]
    }
  ]
};
...
var module_lookup = {
  ...
  "src/routes/church/add.svelte": () => Promise.resolve().then(function() {
    return add;
  }),
  "src/routes/video/index.svelte": () => Promise.resolve().then(function() {
    return index;
  }),
  "src/routes/video/[id].svelte": () => Promise.resolve().then(function() {
    return _id_;
  })
};
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-cfa5f36c.js", "css": ["/./_app/assets/pages/__layout.svelte-c0b8e158.css"], "js": ["/./_app/pages/__layout.svelte-cfa5f36c.js", "/./_app/chunks/vendor-18270294.js"], "styles": [] }, "src/routes/__error.svelte": { "entry": "/./_app/pages/__error.svelte-d51a663b.js", "css": [], "js": ["/./_app/pages/__error.svelte-d51a663b.js", "/./_app/chunks/vendor-18270294.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-5b64f65c.js", "css": [], "js": ["/./_app/pages/index.svelte-5b64f65c.js", "/./_app/chunks/vendor-18270294.js"], "styles": [] }, "src/routes/church/add.svelte": { "entry": "/./_app/pages/church/add.svelte-4862fde7.js", "css": ["/./_app/assets/pages/church/add.svelte-0bc47437.css"], "js": ["/./_app/pages/church/add.svelte-4862fde7.js", "/./_app/chunks/vendor-18270294.js"], "styles": [] }, "src/routes/video/index.svelte": { "entry": "/./_app/pages/video/index.svelte-5a34b0e3.js", "css": [], "js": ["/./_app/pages/video/index.svelte-5a34b0e3.js", "/./_app/chunks/vendor-18270294.js"], "styles": [] }, "src/routes/video/[id].svelte": { "entry": "/./_app/pages/video/[id].svelte-96eea298.js", "css": ["/./_app/assets/pages/video/[id].svelte-c3b43561.css"], "js": ["/./_app/pages/video/[id].svelte-96eea298.js", "/./_app/chunks/vendor-18270294.js"], "styles": [] } };
...
var { Sequelize, DataTypes, Model } = pkg;
...
var Church = class extends Model {
};
Church.init({
  id: {
...
(async () => {
  try {
    ...
    console.error("Unable to connect to the database:", error2);
  }
})();
var headers = {
...
var get = async () => {
  let body = [];
  try {
    body = await Church.findAll({ attributes: ["id", "name", "location", "color"] });
  } catch (e) {
...
var post = async ({ body }) => {
  ...
  try {
    if (typeof body == "string") {
      ...
      let data = {};
      params.forEach((value, key, _) => data[key] = value);
...
var css$2 = {
  code: "#nav-brand.svelte-1tqcvay{flex:4}",
  map: `{"version":3,"file":"__layout.svelte","sources":["__layout.svelte"],"sourcesContent":["<script lang=\\"ts\\">import '../app.css';\\nimport { page } from '$app/stores';\\nconst navLinks = [\\n    { name: 'home', href: '/' },\\n    { name: 'video', href: '/video' },\\n    { name: 'plus', href: '/church/add' }\\n];\\n<\/script>\\n\\n<header class=\\"md:my-10 md:flex mx-10 md:justify-between items-baseline\\">\\n\\t<h1 class=\\"text-2xl text-center md:text-left flex-auto hidden md:block\\" id=\\"nav-brand\\">\\n\\t\\tMy Video\\n\\t</h1>\\n\\n\\t<nav\\n\\t\\tclass=\\"fixed -inset-x-0 bottom-0 flex justify-around p-3 border border-top text-2xl md:relative md:border-none flex-auto bg-gray-50 md:bg-white\\"\\n\\t>\\n\\t\\t{#each navLinks as { name, href }}\\n\\t\\t\\t<a\\n\\t\\t\\t\\t{href}\\n\\t\\t\\t\\tclass=\\"hover:text-blue-800\\"\\n\\t\\t\\t\\tclass:text-blue-800={$page.path == href}\\n\\t\\t\\t\\tsveltekit:prefetch><i class=\\"fas fa-{name}\\" /></a\\n\\t\\t\\t>\\n\\t\\t{/each}\\n\\t</nav>\\n</header>\\n\\n<slot />\\n\\n<style>/* purgecss start ignore */\\n\\n#nav-brand {\\n  flex: 4;\\n}\\n\\n/* purgecss end ignore */</style>\\n"],"names":[],"mappings":"AAgCA,UAAU,eAAC,CAAC,AACV,IAAI,CAAE,CAAC,AACT,CAAC"}`
};
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<header class="${"md:my-10 md:flex mx-10 md:justify-between items-baseline"}"><h1 class="${"text-2xl text-center md:text-left flex-auto hidden md:block svelte-1tqcvay"}" id="${"nav-brand"}">My Video
	</h1>

	<nav class="${"fixed -inset-x-0 bottom-0 flex justify-around p-3 border border-top text-2xl md:relative md:border-none flex-auto bg-gray-50 md:bg-white"}">${each(navLinks, ({ name, href }) => `<a${add_attribute("href", href, 0)} class="${["hover:text-blue-800", $page.path == href ? "text-blue-800" : ""].join(" ").trim()}" sveltekit:prefetch><i class="${"fas fa-" + escape2(name)}"></i></a>`)}</nav></header>
...
var load$1 = ({ fetch: fetch2 }) => __awaiter(void 0, void 0, void 0, function* () {
  const res = yield fetch2("/church.json");
  if (res.ok) {
    const churches = yield res.json();
    return { props: { churches } };
  }
});
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { churches } = $$props;
  if ($$props.churches === void 0 && $$bindings.churches && churches !== void 0)
    $$bindings.churches(churches);
  return `<div class="${" container mx-auto py-10"}"><h2 class="${"text-2xl mx-4"}">Public Churches</h2>
	<div class="${"grid md:grid-cols-5 grid-cols-1"}">${each(churches, ({ id, name, location, color }) => `<a href="${"/video/" + escape2(id)}" style="${"background-color: " + escape2(color) + ";"}" class="${"block border border-black hover:shadow-xl  p-10 my-7 mx-4 rounded-xl md:text-center bg-cover  church"}"><h3 class="${"font-bold"}">${escape2(name)}</h3>
				<p>${escape2(location)}</p>
			</a>`)}</div></div>`;
});
...
var Add = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${`<form action="${"post"}" class="${"grid grid-cols-1 md:grid-cols-2 container w-screen py-6 px-4 container mx-auto md:gap-x-28 md:gap-y-14  gap-x content-center items-stretch"}"${add_attribute("this", form, 0)}><h2 class="${" text-center text-3xl md:col-span-2 my-10"}">Add a church</h2>

		<div><input required type="${"text"}" placeholder="${"Church name"}" name="${"name"}" class="${"svelte-tjt368"}">
			<input required type="${"text"}" placeholder="${"Location"}" name="${"location"}" class="${"svelte-tjt368"}">

			<label><h3 class="${"p-3"}">Color</h3>
				<input required type="${"color"}" class="${"h-16 bg-white svelte-tjt368"}" name="${"color"}" value="${"#1E40AF"}"></label></div>

		<div><input required type="${"number"}" placeholder="${"Number of Participants"}" name="${"noParticipants"}" min="${"2"}" class="${"svelte-tjt368"}">

			<input required type="${"text"}" placeholder="${"Admin code"}" name="${"adminCode"}" class="${"svelte-tjt368"}">
			<input required type="${"text"}" placeholder="${"Participant code"}" name="${"participantCode"}" class="${"svelte-tjt368"}">
			<div class="${"md:mt-3 h-16"}"><button type="${"submit"}" class="${"btn float-right border-black"}">Next </button></div></div></form>`}`;
});
...
initAria();
var css = {
  code: "video.svelte-13g81ul{height:100%;width:100%;border-radius:0.75rem}.full-video.svelte-13g81ul{-o-object-fit:cover;object-fit:cover}.thumbnail-video.svelte-13g81ul{height:200px;width:200px;-o-object-position:center top;object-position:center top;-o-object-fit:cover;object-fit:cover}iframe.svelte-13g81ul{aspect-ratio:16/9}",
  map: `{"version":3,"file":"[id].svelte","sources":["[id].svelte"],"sourcesContent":["<script type=\\"ts\\" context=\\"module\\">export const load = ({ page }) => {\\n    const { params } = page;\\n    const roomId = params.id;\\n    return {\\n        status: 200,\\n        props: { roomId }\\n    };\\n};\\n<\/script>\\n\\n<script type=\\"ts\\">var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\\n    return new (P || (P = Promise))(function (resolve, reject) {\\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\\n        function rejected(value) { try { step(generator[\\"throw\\"](value)); } catch (e) { reject(e); } }\\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\\n    });\\n};\\nimport io from 'socket.io-client';\\nlet videoChats = [{ id: 'dd', name: '', stream: undefined }];\\nimport { flip } from 'svelte/animate';\\nimport Chat from '$lib/Chat.svelte';\\nimport { dndzone, overrideItemIdKeyNameBeforeInitialisingDndZones } from 'svelte-dnd-action';\\nimport { onMount } from 'svelte';\\noverrideItemIdKeyNameBeforeInitialisingDndZones('id');\\nlet chat = false;\\nlet mic = false;\\nlet cam = false;\\nlet seat = 0;\\nexport let roomId;\\n/**\\n * Three processes are involved\\n * 0 : The chair view\\n * 1 : Thumbnail\\n * 2 : View\\n */\\nlet process = 0;\\nfunction nextProcess() {\\n    if (process === 2)\\n        process -= 1;\\n    else\\n        process += 1;\\n}\\nfunction handleDND(e) {\\n    videoChats = e.detail.items;\\n}\\nfunction toggleMic(e, value = !mic) {\\n    return __awaiter(this, void 0, void 0, function* () {\\n        mic = value;\\n        console.log('toggleMic', mic);\\n        videoChats[0].stream.getAudioTracks().forEach((track) => (track.enabled = mic));\\n    });\\n}\\nfunction toggleCam(e, value = !cam) {\\n    return __awaiter(this, void 0, void 0, function* () {\\n        cam = value;\\n        console.log('toggleCam', cam);\\n        videoChats[0].stream.getVideoTracks().forEach((track) => (track.enabled = cam));\\n    });\\n}\\nfunction allowStream() {\\n    return __awaiter(this, void 0, void 0, function* () {\\n        return yield navigator.mediaDevices.getUserMedia({\\n            video: true,\\n            audio: true\\n        });\\n    });\\n}\\nfunction video(node, stream) {\\n    if (stream === null || stream === void 0 ? void 0 : stream.getTracks().length)\\n        node.srcObject = stream;\\n    node.onloadedmetadata = function (e) {\\n        node.play();\\n    };\\n    return {\\n        update(stream) {\\n            video(node, stream);\\n        }\\n    };\\n}\\nonMount(() => __awaiter(void 0, void 0, void 0, function* () {\\n    localStorage.debug = '*';\\n    const stream = yield allowStream();\\n    videoChats[0].stream = stream;\\n    toggleCam(null, false);\\n    toggleMic(null, false);\\n    const socket = io('/');\\n    // const { default: Peer } = await import('peerjs');\\n    console.log('This is not a peer');\\n    const peer = new Peer(undefined, { host: '/', port: 9000 });\\n    peer.on('connection', () => console.log('connected'));\\n    toggleCam(null, false);\\n    toggleMic(null, false);\\n    console.log(io);\\n    peer.on('open', (id) => {\\n        socket.emit('join-room', roomId, id);\\n    });\\n    let user;\\n    socket.on('user-connected', (userId) => {\\n        console.log('User connected', userId);\\n    });\\n}));\\nfunction connectToNewUser(peer, userId, stream) {\\n    const call = peer.call(userId, stream);\\n    let id;\\n    call.on('stream', (userVideoStream) => {\\n        id = addVideoStream(userVideoStream, userId);\\n    });\\n    call.on('close', () => videoChats.splice(id, 1));\\n}\\nfunction addVideoStream(stream, userId) {\\n    videoChats = [...videoChats, { name: '', stream, id: userId }];\\n    return videoChats.length - 1;\\n}\\n<\/script>\\n\\n<svelte:head>\\n\\t<title>VIDEO CHAT</title>\\n\\t<script src=\\"https://unpkg.com/peerjs@1.3.1/dist/peerjs.min.js\\" defer><\/script>\\n</svelte:head>\\n\\n<div class=\\"container mx-auto p-2\\">\\n\\t<div class=\\"md:flex flex-wrap mb-3\\">\\n\\t\\t<iframe\\n\\t\\t\\tclass=\\"md:w-8/12\\"\\n\\t\\t\\tsrc=\\"https://www.youtube.com/embed/pF0WLHERdOQ\\"\\n\\t\\t\\ttitle=\\"YouTube video player\\"\\n\\t\\t\\tframeborder=\\"0\\"\\n\\t\\t\\tallow=\\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture\\"\\n\\t\\t\\tallowfullscreen\\n\\t\\t/>\\n\\t\\t<div class=\\"flex-1 p-10 flex flex-col items-stretch justify-center gap-6\\">\\n\\t\\t\\t<h1 class=\\"text-center\\"><i class=\\"fab fa-youtube fa-3x text-red-700\\" /></h1>\\n\\n\\t\\t\\t<h1 class=\\"text-center\\">Name</h1>\\n\\t\\t\\t<a href=\\"\\" class=\\" flex flex-row justify-between\\">\\n\\t\\t\\t\\tSubscribe <span class=\\"text-right\\">33</span></a\\n\\t\\t\\t>\\n\\t\\t\\t<a href=\\"\\"> Likes </a>\\n\\t\\t</div>\\n\\t</div>\\n\\n\\t\\t\\t<!-- use:dndzone={{ items: videoChats, flipDurationMs: 700 }}\\n\\t\\ton:consider={handleDND}\\n\\t\\ton:finalize={handleDND} -->\\n\\t<div\\n\\n\\t\\tclass=\\"grid grid-cols-2 gap-4 md:grid-cols-4 md:gap-4 md:gap-y-12\\"\\n\\t>\\n\\t\\t{#each videoChats as { id, stream }, index}\\n\\t\\t\\t<div\\n\\t\\t\\t\\tclass=\\"border flex flex-col justify-center items-center rounded-xl bg-white\\"\\n\\t\\t\\t\\tclass:py-6={process !== 2}\\n\\t\\t\\t\\ton:dblclick={nextProcess}\\n\\t\\t\\t>\\n\\t\\t\\t\\t{#if process == 0}\\n\\t\\t\\t\\t\\t<h1 class=\\"text-3xl my-4\\">{id}</h1>\\n\\n\\t\\t\\t\\t\\t<span class=\\"fa-stack fa-2x\\"\\n\\t\\t\\t\\t\\t\\t><i class=\\"fas fa-circle text-green-500 fa-stack-2x \\" />\\n\\t\\t\\t\\t\\t\\t<i class=\\"fas fa-chair fa-stack-1x text-white\\" />\\n\\t\\t\\t\\t\\t</span>\\n\\t\\t\\t\\t{:else if process == 1}\\n\\t\\t\\t\\t\\t<h1 class=\\"text-3xl my-4\\">{id}</h1>\\n\\n\\t\\t\\t\\t\\t<!-- svelte-ignore a11y-media-has-caption -->\\n\\t\\t\\t\\t\\t<video autoplay use:video={stream} class=\\"thumbnail-video\\" />\\n\\t\\t\\t\\t{:else}\\n\\t\\t\\t\\t\\t<!-- svelte-ignore a11y-media-has-caption -->\\n\\n\\t\\t\\t\\t\\t<video use:video={stream} autoplay class=\\"full-video\\" />\\n\\t\\t\\t\\t{/if}\\n\\t\\t\\t</div>\\n\\t\\t{/each}\\n\\t</div>\\n</div>\\n\\n<div\\n\\tclass=\\"fixed md:left-0 right-0 bottom-16 md:bottom-5 container mx-auto flex justify-center text-xl flex-row \\"\\n\\tid=\\"controls\\"\\n>\\n\\t<div on:click={toggleMic}>\\n\\t\\t<span class=\\"fa-stack fa-lg rounded-full shadow-xl\\">\\n\\t\\t\\t<i class=\\"fas fa-circle fa-stack-2x\\" class:text-green-600={mic} class:text-red-600={!mic} />\\n\\t\\t\\t<i\\n\\t\\t\\t\\tclass=\\"fas fa-stack-1x fa-inverse\\"\\n\\t\\t\\t\\tclass:fa-microphone={mic}\\n\\t\\t\\t\\tclass:fa-microphone-slash={!mic}\\n\\t\\t\\t/>\\n\\t\\t</span>\\n\\t</div>\\n\\n\\t<div class=\\"md:ml-5\\" on:click={toggleCam}>\\n\\t\\t<span class=\\"fa-stack fa-lg rounded-full shadow-xl\\">\\n\\t\\t\\t<i class=\\"fas fa-circle fa-stack-2x \\" class:text-green-600={cam} class:text-red-600={!cam} />\\n\\t\\t\\t<i class=\\"fas fa-video fa-stack-1x fa-inverse\\" />\\n\\t\\t</span>\\n\\t</div>\\n\\n\\t<div on:click={() => (chat = !chat)} class=\\"md:ml-5\\">\\n\\t\\t<span class=\\"fa-stack fa-lg rounded-full shadow-xl\\">\\n\\t\\t\\t<i class=\\"fas fa-circle fa-stack-2x text-indigo-600\\" />\\n\\t\\t\\t<i class=\\"fas fa-praying-hands fa-stack-1x fa-inverse\\" />\\n\\t\\t</span>\\n\\t</div>\\n\\n\\t<div\\n\\t\\ton:click={() => {\\n\\t\\t\\tprocess = 0;\\n\\t\\t\\tmic = false;\\n\\t\\t\\tcam = false;\\n\\t\\t}}\\n\\t\\tclass=\\"md:ml-5\\"\\n\\t>\\n\\t\\t<span class=\\"fa-stack fa-lg rounded-full shadow-xl\\">\\n\\t\\t\\t<i class=\\"fas fa-circle fa-stack-2x text-purple-700\\" />\\n\\t\\t\\t<i class=\\"fas fa-chair fa-stack-1x fa-inverse\\" />\\n\\t\\t</span>\\n\\t</div>\\n</div>\\n\\n{#if chat}\\n\\t<Chat on:visible={() => (chat = false)} />\\n{/if}\\n\\n<style>/* purgecss start ignore */\\n\\nvideo {\\n  height: 100%;\\n  width: 100%;\\n  border-radius: 0.75rem;\\n}\\n\\n.full-video {\\n  -o-object-fit: cover;\\n     object-fit: cover;\\n}\\n\\n.thumbnail-video {\\n  height: 200px;\\n  width: 200px;\\n  -o-object-position: center top;\\n     object-position: center top;\\n  -o-object-fit: cover;\\n     object-fit: cover;\\n}\\n\\niframe {\\n  aspect-ratio: 16/9;\\n}\\n\\n/* purgecss end ignore */</style>\\n"],"names":[],"mappings":"AAoOA,KAAK,eAAC,CAAC,AACL,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,aAAa,CAAE,OAAO,AACxB,CAAC,AAED,WAAW,eAAC,CAAC,AACX,aAAa,CAAE,KAAK,CACjB,UAAU,CAAE,KAAK,AACtB,CAAC,AAED,gBAAgB,eAAC,CAAC,AAChB,MAAM,CAAE,KAAK,CACb,KAAK,CAAE,KAAK,CACZ,kBAAkB,CAAE,MAAM,CAAC,GAAG,CAC3B,eAAe,CAAE,MAAM,CAAC,GAAG,CAC9B,aAAa,CAAE,KAAK,CACjB,UAAU,CAAE,KAAK,AACtB,CAAC,AAED,MAAM,eAAC,CAAC,AACN,YAAY,CAAE,EAAE,CAAC,CAAC,AACpB,CAAC"}`
};
var load = ({ page: page2 }) => {
  const { params } = page2;
  const roomId = params.id;
  return { status: 200, props: { roomId } };
};
var U5Bidu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let videoChats = [{ id: "dd", name: "", stream: void 0 }];
  overrideItemIdKeyNameBeforeInitialisingDndZones("id");
  let { roomId } = $$props;
  if ($$props.roomId === void 0 && $$bindings.roomId && roomId !== void 0)
    $$bindings.roomId(roomId);
  $$result.css.add(css);
  return `${$$result.head += `${$$result.title = `<title>VIDEO CHAT</title>`, ""}<script src="${"https://unpkg.com/peerjs@1.3.1/dist/peerjs.min.js"}" defer data-svelte="svelte-4n7nzi"><\/script>`, ""}

<div class="${"container mx-auto p-2"}"><div class="${"md:flex flex-wrap mb-3"}"><iframe class="${"md:w-8/12 svelte-13g81ul"}" src="${"https://www.youtube.com/embed/pF0WLHERdOQ"}" title="${"YouTube video player"}" frameborder="${"0"}" allow="${"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"}" allowfullscreen></iframe>
		<div class="${"flex-1 p-10 flex flex-col items-stretch justify-center gap-6"}"><h1 class="${"text-center"}"><i class="${"fab fa-youtube fa-3x text-red-700"}"></i></h1>

			<h1 class="${"text-center"}">Name</h1>
			<a href="${""}" class="${" flex flex-row justify-between"}">Subscribe <span class="${"text-right"}">33</span></a>
			<a href="${""}">Likes </a></div></div>

			
	<div class="${"grid grid-cols-2 gap-4 md:grid-cols-4 md:gap-4 md:gap-y-12"}">${each(videoChats, ({ id, stream }, index2) => `<div class="${[
    "border flex flex-col justify-center items-center rounded-xl bg-white",
    "py-6"
  ].join(" ").trim()}">${`<h1 class="${"text-3xl my-4"}">${escape2(id)}</h1>

					<span class="${"fa-stack fa-2x"}"><i class="${"fas fa-circle text-green-500 fa-stack-2x "}"></i>
						<i class="${"fas fa-chair fa-stack-1x text-white"}"></i>
					</span>`}
			</div>`)}</div></div>

<div class="${"fixed md:left-0 right-0 bottom-16 md:bottom-5 container mx-auto flex justify-center text-xl flex-row "}" id="${"controls"}"><div><span class="${"fa-stack fa-lg rounded-full shadow-xl"}"><i class="${[
    ...
    " fa-microphone-slash"
  ].join(" ").trim()}"></i></span></div>

	<div class="${"md:ml-5"}"><span class="${"fa-stack fa-lg rounded-full shadow-xl"}"><i class="${[
    "fas fa-circle fa-stack-2x ",
    " text-red-600"
  ].join(" ").trim()}"></i>
			<i class="${"fas fa-video fa-stack-1x fa-inverse"}"></i></span></div>

	<div class="${"md:ml-5"}"><span class="${"fa-stack fa-lg rounded-full shadow-xl"}"><i class="${"fas fa-circle fa-stack-2x text-indigo-600"}"></i>
			<i class="${"fas fa-praying-hands fa-stack-1x fa-inverse"}"></i></span></div>

	<div class="${"md:ml-5"}"><span class="${"fa-stack fa-lg rounded-full shadow-xl"}"><i class="${"fas fa-circle fa-stack-2x text-purple-700"}"></i>
			<i class="${"fas fa-chair fa-stack-1x fa-inverse"}"></i></span></div></div>
  ...
  for (; i < arr.length; i++) {
    ...
    if (abs.startsWith(dir) && existsSync(abs)) {
      ...
      if (stats.isDirectory())
        continue;
      headers2 = toHeaders(name, stats, isEtag);
      headers2["Cache-Control"] = isEtag ? "no-cache" : "no-store";
      return { abs, stats, headers: headers2 };
    }
  }
}
...
function send(req, res, file, stats, headers2) {
  let code = 200, tmp, opts = {};
  headers2 = __spreadValues({}, headers2);
  ...
  if (req.headers.range) {
    ...
    headers2["Content-Range"] = `bytes ${start}-${end}/${stats.size}`;
    headers2["Content-Length"] = end - start + 1;
    headers2["Accept-Ranges"] = "bytes";
  }
  res.writeHead(code, headers2);
  createReadStream(file, opts).pipe(res);
}
function isEncoding(name, type, headers2) {
  headers2["Content-Encoding"] = type;
  headers2["Content-Type"] = lite.getType(name.replace(/\.([^.]*)$/, "")) || "";
}
function toHeaders(name, stats, isEtag) {
  ...
  if (isEtag)
    headers2["ETag"] = `W/"${stats.size}-${stats.mtime.getTime()}"`;
  if (/\.br$/.test(name))
    isEncoding(name, "br", headers2);
  if (/\.gz$/.test(name))
    isEncoding(name, "gzip", headers2);
  return headers2;
}
  ...
  if (!opts.dev) {
    list(dir, (name, abs, stats) => {
      if (/\.well-known[\\+\/]/.test(name))
        ...
        return;
      let headers2 = toHeaders(name, stats, isEtag);
      if (cc)
        headers2["Cache-Control"] = cc;
      FILES["/" + name.normalize().replace(/\\+/g, "/")] = { abs, stats, headers: headers2 };
    });
  }
